...
```bash
# Score all episodes
python -m coherence_ops score ./examples/05-healthcare-lattice/episodes/ --json

# Score a specific episode
python -m coherence_ops score ./examples/05-healthcare-lattice/episodes/ep-hc-001.json --json

# Get letter grade
python -m coherence_ops score ./examples/05-healthcare-lattice/episodes/
...
python -m coherence_ops.examples.drift_patch_cycle --example healthcare
...
```bash
python -m coherence_ops iris query --type WHY --target ep-hc-001
```
