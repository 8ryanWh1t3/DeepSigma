...
ALLOWED_ACRONYMS = {
    ...
    "BEACON", "SKEW", "BOOT", "RETCON", "PEGI", "CERO", "ESRB", "MEE", "TAMPER",
    "HEATMAP", "BLAST", "TRILOGY", "LINEAGE", "GRAPH", "CONTRADICTION",
    ...
    "DENIED", "TIMING", "LAG", "WEST", "BROKEN", "DROP", "GPO", "GUIDED", "PANEL", "PREFS", "SCIF", "TASK", "TOUR", "USB", "ZONE",
    ...
    # AuthorityOps — models, audit IDs, positioning doc terms, OpenPQL prefixes
    "IAM", "AGENT", "TINY", "SMALL", "LARGE", "AUDIT", "ACT", "PSRC", "RGATE",
    ...
    "TOGGLE", "NORMAL", "VIEW", "MODE", "CTA", "STRIP",
    # v1.0.4 scenario labels and mock signature names
    ...
    # CERPA PURPLE workbench — exercise lifecycle, ATT&CK, detection, security tokens
    "BLUE", "CASB", "DBSRV", "DLP", "DOC", "DOCX", "FORGE", "IRON",
