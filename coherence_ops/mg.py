...
class MemoryGraph:
    ...
    def add_drift(self, drift: Dict[str, Any]) -> str:
        ...
        for nid, node in self._nodes.items():
                    ...
                    logger.debug("Added drift node %s (type=%s)",
    ...
    def add_claim(self, claim: Dict[str, Any], episode_id: Optional[str] = None) -> str:
        ...
        logger.debug("Added claim node %s (type=%s, confidence=%s)",
