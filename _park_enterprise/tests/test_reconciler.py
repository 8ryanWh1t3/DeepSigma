"""Tests for coherence_ops.reconciler — cross-artifact reconciliation."""
...
class TestRepairProposal:
    def test_proposal_fields(self):
        from coherence_ops.reconciler import RepairProposal, RepairKind
        p = RepairProposal(
    ...
    def test_repair_kind_values(self):
        from coherence_ops.reconciler import RepairKind
