...
python -m core mg export ./core/examples/ --format=graphml
python -m core mg export ./core/examples/ --format=neo4j-csv
...
python -m core iris query --type RECALL --target ep-042 --limit 10
python -m core iris query --type WHAT_CHANGED
