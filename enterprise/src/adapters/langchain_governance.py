"""
adapters/langchain_governance.py — DTE-enforcing callback handler for LangChain
================================================================================
...
Usage::
    ...
    from adapters.langchain_governance import GovernanceCallbackHandler
    from engine.dte_enforcer import DTEEnforcer

    enforcer = DTEEnforcer(dte_spec)
    handler = GovernanceCallbackHandler(dte_enforcer=enforcer, on_violation="raise")
...
class GovernanceCallbackHandler(BaseCallbackHandler):
    """LangChain callback that enforces DTE constraints mid-chain.

    Parameters
    ----------
    dte_enforcer : DTEEnforcer
        Instance from ``engine/dte_enforcer.py``.
    project : str
    ...
    def on_llm_start(
        ...
        **kwargs: Any,
        ...
        pass  # Just tracking; DTE check happens on_llm_end
    ...
    def on_llm_error(
        ...
        **kwargs: Any,
        ...
        pass  # Errors don't trigger DTE checks
    ...
    def _emit_drift(self, violations: List[Dict[str, Any]]) -> None:
        ...
        try:
            ...
            from adapters._exhaust_helpers import _make_event_id, _utcnow
