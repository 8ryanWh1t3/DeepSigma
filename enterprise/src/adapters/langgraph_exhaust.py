"""
adapters/langgraph_exhaust.py – LangGraph async event tracker for Exhaust Inbox
================================================================================
Tracks graph node execution, edge traversal, and state checkpoints from
LangGraph's astream_events() output.  Optionally enforces DTE constraints
...
class LangGraphExhaustTracker:
    ...
    dte_enforcer : optional
        A :class:`DTEEnforcer` instance for constraint checking.
