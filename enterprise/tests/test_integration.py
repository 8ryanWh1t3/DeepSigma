...
Exercises:
    ...
    core.DLRBuilder — build Decision Log Records
    core.ReflectionSession — aggregate learning
    core.DriftSignalCollector — ingest drift signals
    core.MemoryGraph — provenance graph + queries
    core.CoherenceScorer — unified 0-100 score
    core.CoherenceAuditor — cross-artifact consistency
    core.Reconciler — detect and auto-fix inconsistencies
"""
...
from core.manifest import ArtifactDeclaration, ArtifactKind, ComplianceLevel
from core.scoring import CoherenceReport
...
SAMPLE_EPISODES = REPO_ROOT / "src" / "core" / "examples" / "sample_episodes.json"
SAMPLE_DRIFT = REPO_ROOT / "src" / "core" / "examples" / "sample_drift.json"
...
class TestEndToEnd:
    ...
    def test_engine_to_coherence_bridge(self, episodes, drift_events, manifest):
        """Verify that engine-stamped episodes feed correctly into core."""
        ...
        # Feed the engine-stamped episode into core
