...
| Resource | Purpose |
|----------|---------|
| [`core/`](core/) | Python library: DLR, RS, DS, MG, Auditor, Scorer, IRIS |
| [`core/cli.py`](core/cli.py) | CLI entrypoint: audit, score, mg export, iris query, demo |
| [`core/examples/`](core/examples/) | sample_episodes.json, sample_drift.json, e2e_seal_to_report.py |
