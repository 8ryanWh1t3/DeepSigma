...
| `test_coherence_bridge.py` | Bridge between core and the engine layer |
...
| `test_api.py` | core public API: scorer, auditor, IRIS query interface |
...
This reports line-by-line coverage for the `core` package. Coverage report goes to terminal.
...
|-----------|---------------|-------------|
| Coverage gating (≥ 80% for core) | v0.4.x | Add `--cov-fail-under=80` to CI |
