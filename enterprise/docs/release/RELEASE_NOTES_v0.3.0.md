...
- **Money Demo** — One-command Drift → Patch cycle (`python -m core.examples.drift_patch_cycle`) producing 8 deterministic artifacts: 3 coherence reports, 3 MG snapshots, a memory graph diff, and a Mermaid diagram
