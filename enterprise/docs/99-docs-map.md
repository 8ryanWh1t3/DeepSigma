...
| Quickstart (run commands) | [`HERO_DEMO.md`](HERO_DEMO.md) | `docs/05-quickstart.md`, `core/README.md` |
...
| Coherence Ops integration | [`docs/10-coherence-ops-integration.md`](10-coherence-ops-integration.md) | `core/README.md` |
...
| JSON schemas | [`specs/`](../specs/) | `core/schemas/`, `llm_data_model/02_schema/` |
...
|---------|-------|---------------|
| Quickstart commands | `docs/05-quickstart.md` vs `HERO_DEMO.md` vs `core/README.md` | `HERO_DEMO.md` is the canonical hero path. `docs/05-quickstart.md` should link to it. `core/README.md` keeps CLI-specific examples. |
...
| Coherence Ops architecture | `docs/10-coherence-ops-integration.md` vs `core/README.md` | `core/README.md` = library-level (modules, CLI). `docs/10-…` = integration guide (how to connect to RAL). No action needed. |
| Schema sources | `specs/` vs `core/schemas/` vs `llm_data_model/02_schema/` | `specs/` = canonical JSON schemas. `core/schemas/` = library-specific (manifest, report). `llm_data_model/02_schema/` = LLM field dictionary. |
