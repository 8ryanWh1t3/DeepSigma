...
**Schema:** [`specs/dte.schema.json`](https://github.com/8ryanWh1t3/DeepSigma/blob/main/enterprise/schemas/core/dte.schema.json) · [Full reference →](DTE-Schema)
...
**Schema:** [`specs/action_contract.schema.json`](https://github.com/8ryanWh1t3/DeepSigma/blob/main/enterprise/schemas/core/action_contract.schema.json) · [Full reference →](Action-Contract-Schema)
...
**Schema:** [`specs/episode.schema.json`](https://github.com/8ryanWh1t3/DeepSigma/blob/main/enterprise/schemas/core/episode.schema.json) · [Full reference →](Episode-Schema)
