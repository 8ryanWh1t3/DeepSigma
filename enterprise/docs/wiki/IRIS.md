...
```python
from core.iris import IRISEngine, IRISQuery, QueryType
...
| File | Description |
|------|-------------|
| `core/iris.py` | Engine implementation |
| `specs/iris_query.schema.json` | JSON Schema contract |
| `core/cli.py` | CLI `coherence iris query` |
...
See [Glossary](Glossary) and [GLOSSARY.md](https://github.com/8ryanWh1t3/DeepSigma/blob/main/enterprise/docs/GLOSSARY.md):
...
See also: [Language Map](https://github.com/8ryanWh1t3/DeepSigma/blob/main/enterprise/docs/01-language-map.md) for LinkedIn-to-Code mappings (IRIS = Phase 2).
