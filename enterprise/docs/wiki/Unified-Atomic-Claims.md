...
>
> **Schema**: [`specs/claim.schema.json`](https://github.com/8ryanWh1t3/DeepSigma/blob/main/enterprise/schemas/core/claim.schema.json)
> **Docs**: [`docs/19-claim-primitive.md`](https://github.com/8ryanWh1t3/DeepSigma/blob/main/enterprise/docs/19-claim-primitive.md)
>
> ## Anatomy of a Claim
>
> Every Claim has:
...
>      
>       5. **Schema**: [`specs/dlr.schema.json`](https://github.com/8ryanWh1t3/DeepSigma/blob/main/enterprise/schemas/core/dlr.schema.json)
>       6. **Docs**: [`docs/20-dlr-claim-native.md`](https://github.com/8ryanWh1t3/DeepSigma/blob/main/enterprise/docs/20-dlr-claim-native.md)
>      
>       7. ## Composability
>
...
> ## Diagrams
>
> See [`archive/mermaid/27-claim-primitive.md`](https://github.com/8ryanWh1t3/DeepSigma/blob/main/enterprise/docs/archive/mermaid/27-claim-primitive.md) and [`archive/mermaid/28-dlr-claim-native.md`](https://github.com/8ryanWh1t3/DeepSigma/blob/main/enterprise/docs/archive/mermaid/28-dlr-claim-native.md) for visual architecture.
>
> ## Related Pages
>
