...
4. **Storage backend** — For production deployments exceeding 100k records, consider the SQLite or PostgreSQL storage backends (see `core/storage.py`) which provide indexed queries and ACID guarantees.
