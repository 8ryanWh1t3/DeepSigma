...
| Module | Status |
|--------|--------|
| `core.dlr.DLRBuilder` | Internal — constructor kwargs may change |
| `core.rs.ReflectionSession` | Internal — session API may evolve |
| `core.scoring.CoherenceScorer` | Internal — dimension weights not frozen |
| `core.iris.IRISEngine` | Internal — query resolution evolving |
