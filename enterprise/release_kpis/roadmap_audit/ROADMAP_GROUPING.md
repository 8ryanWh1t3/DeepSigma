...
- #16 **Build comprehensive Wiki documentation (47+ pages)**  
  labels: documentation
- #17 **Add unit tests for core package**  
  labels: enhancement
...
- #21 **Add REST API endpoints for CoherenceOps and LLM Data Model**  
  labels: enhancement
- #22 **Update repo README to reference core, llm_data_model, and mermaid folders**  
  labels: documentation
- #23 **Add CLI, end-to-end examples, and demo command to core**  
  labels: enhancement
