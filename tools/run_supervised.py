...
conforming to specs/drift.schema.json.
...
def main():
    ...
    ap.add_argument("--verification", default="na",
    ...
    if drift_type:
              drift_event = {
                            ...
                            "fingerprint": seal_hash({"decisionType": args.decisionType, "type": drift_type, **drift_details}),
